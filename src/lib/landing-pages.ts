...
export const LANDING_PAGES: LandingPage[] = [
  ...
  },
  {
    ...
    metaDescription:
      'Paste a job description and see how well your resume matches it, a free fit verdict and match score, plus the exact missing keywords in the full report.',
    eyebrow: 'Job Match Checker',
    h1: 'Match your resume to a job',
    lead: 'Generic resume advice tells you to "tailor it more." This gives you a number: paste the job description and see your match score against that specific role, whether you are a strong or weak fit, and how many keywords you are missing before you decide it is worth applying.',
    ...
    bullets: [
      ...
      { title: 'Keywords you already match', desc: 'The requirements from the posting your resume already covers.' },
      { title: 'How many keywords are missing', desc: 'The count is free. The full report lists the exact missing terms and rewrites your bullets to include them.' },
    ],
    sections: [
      {
        h2: '"Tailor your resume" is not specific enough',
        body: [
          'Most advice stops at "customize your resume for each job" without saying what to actually change. Pasting the job description alongside your resume turns that into something you can check: a match score, a fit verdict, and how many requirements from the posting your resume is missing.',
      ...
      {
        h2: 'Free score, paid keyword list',
        body: [
          'The match score, fit verdict, the keywords you already cover, and the count of what is missing are all free with no account. You will know where you stand against that specific job before deciding what to do next.',
          'The one-time €1.99 report goes further: it names the exact missing keywords and rewrites your bullet points to work them in naturally, on your actual resume rather than a template.',
        ],
      },
    ],
    faq: [
      { q: 'Do I need a job description to use this?', a: 'No, you can get your general CV score without one. Adding a job description unlocks the match score and fit verdict against that specific role.' },
      { q: 'Is the match check free?', a: 'The match score, fit verdict, and a count of missing keywords are free with no signup. The exact list of missing keywords is in the one-time €1.99 report.' },
      ...
      { q: 'What counts as a strong match?', a: 'It depends on the role, but the fit verdict (strong, possible, or weak) gives you a quick read before you look at anything else.' },
    ],
