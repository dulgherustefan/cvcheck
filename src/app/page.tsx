...
export default function Home() {
  ...
  const S = {
    ...
    h2: { fontSize:'clamp(24px,3vw,36px)' as const, fontWeight:900, color:'var(--text-primary)', lineHeight:0.88, marginBottom:14, letterSpacing:'-0.035em', fontFamily:'var(--font-display)' },
    ...
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column' as const, background:'var(--bg)', fontFamily:'var(--font-sans)' }}>
      ...
      <main style={{ flex:1 }}>
        ...
        <section style={{ background:'var(--bg-elevated)', padding:'80px 40px 60px', textAlign:'center' as const }}>
          <div style={S.wrap}>
            <h1 style={{ fontSize:'clamp(44px,6vw,74px)', fontWeight:900, lineHeight:0.88, color:'var(--text-primary)', marginBottom:20, letterSpacing:'-0.04em', fontFamily:'var(--font-display)' }}>
        ...
        {(appState==='idle'||appState==='error')&&(<>
          ...
          <section id="analysis" style={{ background:'var(--bg-elevated)', padding:'96px 40px 80px' }}>
            <div style={{ maxWidth:960, margin:'0 auto', textAlign:'center' as const }}>
              ...
              <h2 data-sr data-sr-delay="0.08" style={{ fontSize:'clamp(30px,4vw,48px)', fontWeight:900, color:'var(--text-primary)', lineHeight:0.88, letterSpacing:'-0.035em', fontFamily:'var(--font-display)', marginBottom:16, maxWidth:640, margin:'0 auto 16px' }}>Every recruiter bias, every ATS gap — exposed.</h2>
          ...
          <section id="jobs" style={{ background:'var(--bg)', padding:'96px 40px 80px' }}>
            <div style={{ maxWidth:960, margin:'0 auto', textAlign:'center' as const }}>
              ...
              <h2 data-sr data-sr-delay="0.08" style={{ fontSize:'clamp(30px,4vw,48px)', fontWeight:900, color:'var(--text-primary)', lineHeight:0.88, letterSpacing:'-0.035em', fontFamily:'var(--font-display)', marginBottom:16, maxWidth:600, margin:'0 auto 16px' }}>Jobs that actually fit — with a score to prove it.</h2>
          ...
          <section style={{ background:'var(--bg)', padding:'96px 40px' }}>
            <div style={{ maxWidth:960, margin:'0 auto', textAlign:'center' as const }}>
              ...
              <h2 style={{ fontSize:'clamp(30px,4vw,48px)', fontWeight:900, color:'var(--text-primary)', lineHeight:0.88, letterSpacing:'-0.035em', fontFamily:'var(--font-display)', marginBottom:16, maxWidth:560, margin:'0 auto 56px' }}>Done before your coffee gets cold.</h2>
          ...
          <section style={{ background:'var(--bg-subtle)', padding:'80px 40px', borderTop:'0.5px solid var(--border)' }}>
            <div style={{ maxWidth:960, margin:'0 auto', textAlign:'center' as const }}>
              <h2 style={{ fontSize:'clamp(24px,3vw,36px)', fontWeight:900, color:'var(--text-primary)', letterSpacing:'-0.03em', fontFamily:'var(--font-display)', marginBottom:12 }}>Works for every domain and level.</h2>
          ...
          <section id="pricing" style={{ background:'var(--bg-elevated)', padding:'96px 40px' }}>
            <div style={{ maxWidth:960, margin:'0 auto', textAlign:'center' as const }}>
              ...
              <h2 style={{ fontSize:'clamp(30px,4vw,48px)', fontWeight:900, color:'var(--text-primary)', lineHeight:0.88, letterSpacing:'-0.035em', fontFamily:'var(--font-display)', marginBottom:12, maxWidth:520, margin:'0 auto 12px' }}>No tricks. No "contact us."</h2>
          ...
          <section style={{ background:'var(--bg)', padding:'96px 40px', textAlign:'center' as const, borderTop:'0.5px solid var(--border)' }}>
            <div style={{ maxWidth:680, margin:'0 auto' }}>
              <h2 style={{ fontSize:'clamp(26px,3vw,38px)', fontWeight:900, color:'var(--text-primary)', letterSpacing:'-0.03em', fontFamily:'var(--font-display)', marginBottom:40 }}>The most honest feedback your CV will ever get.</h2>
